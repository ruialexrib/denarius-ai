    ...
    IOptions<GroqCloudOptions>? groqCloudOptions = null, IOptions<NvidiaNimOptions>? nvidiaNimOptions = null) : IApplicationSettingsService
{
    ...
    public async Task UpdateAsync(ApplicationSettingsDto settings, string userId, CancellationToken cancellationToken = default)
    {
        ...
        var values = new Dictionary<string, string>
        {
            ...
            ["Prompts.SavingsLiquidityAnalysis"] = settings.SavingsLiquidityAnalysisPrompt.Trim(),
            ["Prompts.InvestmentPortfolioAnalysis"] = settings.InvestmentPortfolioAnalysisPrompt.Trim(),
            ["Prompts.FinancialCommitmentsAnalysis"] = settings.FinancialCommitmentsAnalysisPrompt.Trim(),
