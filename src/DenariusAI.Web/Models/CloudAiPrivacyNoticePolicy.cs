...
public static class CloudAiPrivacyNoticePolicy
{
    ...
    /// <summary>Determines whether the notice must block the authenticated application UI.</summary>
    ...
    /// <returns><see langword="true"/> when a cloud provider is active and acknowledgement is pending.</returns>
