    ...
    private static IReadOnlyDictionary<string, HelpDetailViewModel> BuildPages()
    {
        var pages = new[]
        {
            ...
            Page("reminders", "Organização", "!", "Lembretes", "Crie avisos para eventos e prazos.", "Reminders", "Index", "Gerir Lembretes",
                ...
                Section("visualizacao", "Lista e calendário", "Escolha a apresentação mais adequada para consultar os lembretes.",
                    "Lista mantém a pesquisa, os filtros por estado e intervalo de datas e as ações existentes.",
                    "Calendário apresenta os lembretes numa grelha mensal de segunda-feira a domingo; use as setas para mudar de mês e Hoje para regressar ao mês atual.",
                    "Cada entrada identifica o estado Por confirmar, Agendado ou Confirmado e pode ser selecionada para editar o respetivo lembrete."),
            ...
            Page("analytics", "Análise", "⌁", "Análise Financeira", "Escolha uma área temática e aprofunde a dimensão financeira que pretende compreender.", "Analytics", "Index", "Abrir Análise",
                Section("catalogo", "Áreas de análise", "A página principal organiza a análise financeira por objetivos.",
                    "Use a pesquisa para localizar uma área por nome, indicador ou conclusão pretendida.",
                    "As seis áreas temáticas estão disponíveis: Visão Financeira Global, Rendimentos/Despesas/Fluxos, Orçamento, Poupança e Liquidez, Investimentos e Património Financeiro e Compromissos Financeiros e Seguros."),
                Section("visao-global", "Visão Financeira Global", "Apresenta uma leitura executiva da posição financeira e da sua evolução.",
                    "Defina De e Até; a comparação usa o período imediatamente anterior com a mesma duração.",
                    "Património, saldo disponível, poupança, taxa de poupança, rendimentos, despesas e respetivas variações são calculados pela aplicação.",
                    "Os destaques aplicam regras determinísticas de materialidade e indicam a área especializada relacionada sem inventar causas.",
                    "Se não existir rendimento no período, a taxa de poupança é apresentada como não aplicável em vez de 0%."),
                Section("evolucao", "Evolução e qualidade dos dados", "A tendência ajuda a distinguir o valor atual da trajetória recente.",
                    "Os gráficos apresentam até 12 meses de património, rendimentos, despesas e poupança.",
                    "Histórico insuficiente, períodos sem movimentos e movimentos por reconciliar são assinalados sem impedir a leitura dos restantes indicadores."),
                Section("fluxos", "Rendimentos, Despesas e Fluxos", "Analisa a origem, destino e circulação do dinheiro no período selecionado.",
                    "Defina De e Até; a comparação usa o intervalo imediatamente anterior com a mesma duração.",
                    "A página apresenta rendimentos, despesas e saldo do período, distribuição por grupos e categorias, pesos relativos e variações.",
                    "Fluxos por conta distinguem entradas, saídas e efeito líquido; transferências entre contas surgem nestes fluxos sem serem tratadas como rendimento ou despesa.",
                    "Os maiores movimentos e os destaques de materialidade ajudam a localizar alterações que justificam consulta do movimento ou extrato subjacente."),
                Section("orcamento-analise", "Orçamento e Execução Orçamental", "Compara o planeado com o realizado no orçamento mensal selecionado.",
                    "Selecione mês e ano; a análise usa exclusivamente a execução associada ao orçamento desse período.",
                    "Grau de execução, desvio total e estados por categoria são calculados pela aplicação.",
                    "Categorias a partir de 85% de execução são assinaladas como próximas do limite; valores acima do orçamento e execução sem valor planeado são destacados separadamente.",
                    "O histórico dos últimos seis meses ajuda a distinguir um desvio pontual de repetições globais, sem duplicar a análise de padrões de despesa da área de fluxos."),
                Section("poupanca-liquidez", "Poupança e Liquidez", "Avalia capacidade de poupança e disponibilidade financeira sem confundir liquidez com investimento.",
                    "Defina De e Até; a poupança e a taxa de poupança são comparadas com o período anterior equivalente.",
                    "Liquidez imediata inclui contas bancárias, numerário e contas de poupança; depósitos a prazo, investimentos e outros ativos ficam fora deste total.",
                    "Saldos noutras moedas são apresentados separadamente e não são convertidos automaticamente para EUR.",
                    "Certificados de Aforro são apresentados como poupança investida, não como liquidez imediata."),
                Section("investimentos", "Investimentos e Património Financeiro", "Consolida ações detidas e Certificados de Aforro mantendo cada moeda separada.",
                    "A watchlist não entra nos totais do património detido.",
                    "Nas ações, custo, valor de mercado, ganho/perda e rentabilidade são calculados a partir da quantidade, custo médio e última cotação guardada.",
                    "Posições noutras moedas não são convertidas nem somadas ao total EUR.",
                    "As previsões estatísticas do módulo de ações continuam indicativas e não são tratadas como resultados realizados."),
                Section("compromissos", "Compromissos Financeiros e Seguros", "Apresenta encargos futuros conhecidos a partir de apólices e prémios registados.",
                    "O horizonte predefinido é de 12 meses a partir da data de referência.",
            ...
            AdminPage("settings", "Administração", "⚙", "Definições e operações globais", "Configure fontes externas, IA, cópias de segurança, demonstração e operações destrutivas.", "Settings", "Index", "Abrir Definições",
                ...
                Section("ia", "Configuração de IA", "A configuração determina o fornecedor e o comportamento das funcionalidades assistidas.",
                    ...
                    "Os prompts operacionais configuráveis afetam extração, classificação e análises. Cada uma das seis áreas de Análise Financeira tem um prompt independente e editável.",
